...
from ._model import SYSTEM_USER_LOGIN, ANONYMOUS_USER_LOGIN, LOGIN_MAX_LENGTH, NICKNAME_MAX_LENGTH, \
    ...
    PROVINCE_MAX_LENGTH, CITY_MAX_LENGTH, STREET_MAX_LENGTH, HOUSE_NUMBER_MAX_LENGTH, APT_NUMBER_MAX_LENGTH, \
    PHONE_MAX_LENGTH, USER_DESCRIPTION_MAX_LENGTH, USER_POSITION_MAX_LENGTH
